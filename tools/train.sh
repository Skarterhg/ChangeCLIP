...
bash tools/dist_train.sh configs/0cd_ce/changeclip_levir.py 2 --work-dir work_dirs/changeclip_levir
bash tools/test.sh LEVIR configs/0cd_ce/changeclip_levir.py 2 work_dirs/changeclip_levir

bash tools/dist_train.sh configs/0cd_ce/changeclip_levir_vit.py 2 --work-dir work_dirs/changeclip_levir_vit
bash tools/test.sh LEVIR configs/0cd_ce/changeclip_levir_vit.py 2 work_dirs/changeclip_levir_vit
